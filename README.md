...
- «Про что проект?» — ожидается вводная секция актуального `README.md`. Регистр, пробелы и пунктуация этого точного вопроса нормализуются; если актуального `README.md` нет, выполняется обычный полнотекстовый поиск.
